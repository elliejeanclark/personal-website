    ...
    return (
        <div>
            ...
            <div className="cards" id="card1">
                <img className="headshots" src="./pictures/headshot1.jpg" alt="headshot" id="headshot1"/>
            ...
            <div className="cards" id="card2">
                <p className="home-text" id="hobbies">
                    I am the oldest daughter of 3 children, and I love my family and friends. I love to read, write, crochet, play the piano, complete jigsaw puzzles, attend live theater, 
                ...
                <img className="headshots" src="./pictures/headshot2.jpg" alt="headshot" id="headshot2" />
            </div>
            <div  className="cards" id="card3">
                <img className="headshots" src="./pictures/headshot3.JPG" alt="headshot" id="headshot3" />
            ...
            <div className="cards" id="card4">
                ...
                <img className="headshots" src="./pictures/headshot4.jpg" alt="headshot" id="headshot4" />
            </div>
            <div className="cards" id="card5">
                <img className="headshots" src="./pictures/headshot5.JPG" alt="headshot" id="headshot5" />
